...
function supprcomm($id)
{
    ...
    if ('' == $id) {
        ...
        $xoopsDB->queryF('DELETE FROM ' . $xoopsDB->prefix('glossaires_comm') . " WHERE id = '$id'");
...
function modifok($id, $def, $auteur, $date, $commentaire, $url)
{
    ...
    if ('' == $id) {
        ...
        $xoopsDB->query('UPDATE ' . $xoopsDB->prefix('glossaires_comm') . " SET id = '$id' , def = '$def' , auteur = '$auteur', date = '$date', commentaire = '$commentaire', url = '$url' , affiche = 'O'  WHERE id='$id'");
...
function modif($id)
{
    ...
    $TableRep = $xoopsDB->query('SELECT id, def, auteur, date, commentaire, url FROM ' . $xoopsDB->prefix('glossaires_comm') . " WHERE id = '$id'");
