...
function modifcatok($idcat, $nomcat)
{
    ...
    if ('' == $idcat) {
        ...
        $xoopsDB->query('UPDATE ' . $xoopsDB->prefix('glossaires_cat') . " SET nomcat = '$nomcat' WHERE idcat='$idcat'");
...
function modifcat($idcat)
{
    ...
    $TableRep = $xoopsDB->query('SELECT idcat, nomcat FROM ' . $xoopsDB->prefix('glossaires_cat') . " WHERE idcat = '$idcat'");
...
function showcat()
{
    ...
    $TableRep = $xoopsDB->query('SELECT idcat, nomcat FROM ' . $xoopsDB->prefix('glossaires_cat') . '');
